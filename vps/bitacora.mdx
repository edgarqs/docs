...
| **Node.js** | `24.13.0` | Entorno de ejecución JS. |
...
| **pm2** | `Active` | **Nuevo:** Gestor de procesos para aplicaciones Node.js. |
...
-- 3. Asignar permisos
GRANT ALL PRIVILEGES ON nombre_de_tu_db.* TO 'nombre_usuario'@'localhost';
FLUSH PRIVILEGES;
```
